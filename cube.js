  ...
  if (microphone.initialized) {
    ...
    cubeScene.traverse(function (object) {
      if (object.isMesh) {
        ...
        object.rotation.y = elapsedTime * midFrequency * settings.cubeSpeed;
        object.rotation.z = elapsedTime * highFrequency * settings.cubeSpeed;
      }
    });
  }
...
function settings_Cube() {
  cubeGUI = new dat.GUI();
  cubeGUI.add(settings, "cubeSpeed", 0, 5, 0.01);
}
