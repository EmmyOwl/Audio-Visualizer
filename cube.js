let cubeScene, cubeCamera, cubeRenderer, cubeGeometry, cubeMaterial, light, microphone, clock, cubeSpeed, cubeOrbitControls;
...
function initCubeVisualizer(mic) {
    ...
    cubeOrbitControls = new THREE.OrbitControls(cubeCamera, cubeRenderer.domElement);
